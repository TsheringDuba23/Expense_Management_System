            ...
            <div class="col-md-6 mt-3">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" class="form-control" placeholder="Designation" value="{{ Auth::user()->designation }}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="department" class="form-control" placeholder="Department" value="{{ Auth::user()->department }}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="basic_pay" class="form-control" placeholder="Basic Pay" value="{{ Auth::user()->basic_pay }}" readonly>
                    </div>
                </div>
                <div class="col-md-6 mt-3">
                    <div class="form-group">
